...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.block1b_dwconv_res2_depthwise = self.__conv(2, name='block1b_dwconv_res2/depthwise', in_channels=16, out_channels=16, kernel_size=(3, 3), stride=(1, 1), groups=16, bias=None)
        ...
        self.block1b_bn_res2_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1b_bn_res2/FusedBatchNorm_1', num_features=16, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block1b_se_reduce_res2_convolution = self.__conv(2, name='block1b_se_reduce_res2/convolution', in_channels=16, out_channels=4, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block1b_se_expand_res2_convolution = self.__conv(2, name='block1b_se_expand_res2/convolution', in_channels=4, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block1b_project_conv_res2_convolution = self.__conv(2, name='block1b_project_conv_res2/convolution', in_channels=16, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        ...
        self.block1b_project_bn_res2_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1b_project_bn_res2/FusedBatchNorm_1', num_features=16, eps=0.0010000000474974513, momentum=0.0)
        self.block1c_dwconv_res1_depthwise = self.__conv(2, name='block1c_dwconv_res1/depthwise', in_channels=24, out_channels=24, kernel_size=(3, 3), stride=(1, 1), groups=24, bias=None)
        ...
        self.block1c_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1c_bn_res1/FusedBatchNorm_1', num_features=24, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block1c_se_reduce_res1_convolution = self.__conv(2, name='block1c_se_reduce_res1/convolution', in_channels=24, out_channels=6, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block1c_se_expand_res1_convolution = self.__conv(2, name='block1c_se_expand_res1/convolution', in_channels=6, out_channels=24, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block1c_project_conv_res1_convolution = self.__conv(2, name='block1c_project_conv_res1/convolution', in_channels=24, out_channels=24, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block1c_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1c_project_bn_res1/FusedBatchNorm_1', num_features=24, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block2a_project_conv_res1_convolution = self.__conv(2, name='block2a_project_conv_res1/convolution', in_channels=144, out_channels=40, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        ...
        self.block2a_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2a_project_bn_res1/FusedBatchNorm_1', num_features=40, eps=0.0010000000474974513, momentum=0.0)
        self.block2b_expand_conv_res1_convolution = self.__conv(2, name='block2b_expand_conv_res1/convolution', in_channels=40, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2b_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2b_expand_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block2b_dwconv_res1_depthwise = self.__conv(2, name='block2b_dwconv_res1/depthwise', in_channels=240, out_channels=240, kernel_size=(3, 3), stride=(1, 1), groups=240, bias=None)
        self.block2c_expand_conv_res2_convolution = self.__conv(2, name='block2c_expand_conv_res2/convolution', in_channels=24, out_channels=144, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2b_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2b_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_expand_bn_res2_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_expand_bn_res2/FusedBatchNorm_1', num_features=144, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_dwconv_res2_depthwise = self.__conv(2, name='block2c_dwconv_res2/depthwise', in_channels=144, out_channels=144, kernel_size=(3, 3), stride=(1, 1), groups=144, bias=None)
        self.block2c_bn_res2_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_bn_res2/FusedBatchNorm_1', num_features=144, eps=0.0010000000474974513, momentum=0.0)
        self.block2b_se_reduce_res1_convolution = self.__conv(2, name='block2b_se_reduce_res1/convolution', in_channels=240, out_channels=10, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2b_se_expand_res1_convolution = self.__conv(2, name='block2b_se_expand_res1/convolution', in_channels=10, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2c_se_reduce_res2_convolution = self.__conv(2, name='block2c_se_reduce_res2/convolution', in_channels=144, out_channels=6, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2b_project_conv_res1_convolution = self.__conv(2, name='block2b_project_conv_res1/convolution', in_channels=240, out_channels=40, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2b_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2b_project_bn_res1/FusedBatchNorm_1', num_features=40, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_se_expand_res2_convolution = self.__conv(2, name='block2c_se_expand_res2/convolution', in_channels=6, out_channels=144, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2c_expand_conv_res1_convolution = self.__conv(2, name='block2c_expand_conv_res1/convolution', in_channels=40, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2c_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_expand_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_project_conv_res2_convolution = self.__conv(2, name='block2c_project_conv_res2/convolution', in_channels=144, out_channels=24, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2c_project_bn_res2_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_project_bn_res2/FusedBatchNorm_1', num_features=24, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_dwconv_res1_depthwise = self.__conv(2, name='block2c_dwconv_res1/depthwise', in_channels=240, out_channels=240, kernel_size=(3, 3), stride=(1, 1), groups=240, bias=None)
        self.block2c_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_se_reduce_res1_convolution = self.__conv(2, name='block2c_se_reduce_res1/convolution', in_channels=240, out_channels=10, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2c_se_expand_res1_convolution = self.__conv(2, name='block2c_se_expand_res1/convolution', in_channels=10, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2c_project_conv_res1_convolution = self.__conv(2, name='block2c_project_conv_res1/convolution', in_channels=240, out_channels=40, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2c_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_project_bn_res1/FusedBatchNorm_1', num_features=40, eps=0.0010000000474974513, momentum=0.0)
        self.block2d_expand_conv_res1_convolution = self.__conv(2, name='block2d_expand_conv_res1/convolution', in_channels=40, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2d_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2d_expand_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2d_dwconv_res1_depthwise = self.__conv(2, name='block2d_dwconv_res1/depthwise', in_channels=240, out_channels=240, kernel_size=(3, 3), stride=(1, 1), groups=240, bias=None)
        self.block2d_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2d_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2d_se_reduce_res1_convolution = self.__conv(2, name='block2d_se_reduce_res1/convolution', in_channels=240, out_channels=10, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2d_se_expand_res1_convolution = self.__conv(2, name='block2d_se_expand_res1/convolution', in_channels=10, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2d_project_conv_res1_convolution = self.__conv(2, name='block2d_project_conv_res1/convolution', in_channels=240, out_channels=40, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2d_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2d_project_bn_res1/FusedBatchNorm_1', num_features=40, eps=0.0010000000474974513, momentum=0.0)
        self.block2e_expand_conv_res1_convolution = self.__conv(2, name='block2e_expand_conv_res1/convolution', in_channels=40, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2e_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2e_expand_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2e_dwconv_res1_depthwise = self.__conv(2, name='block2e_dwconv_res1/depthwise', in_channels=240, out_channels=240, kernel_size=(3, 3), stride=(1, 1), groups=240, bias=None)
        self.block2e_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2e_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block2e_se_reduce_res1_convolution = self.__conv(2, name='block2e_se_reduce_res1/convolution', in_channels=240, out_channels=10, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2e_se_expand_res1_convolution = self.__conv(2, name='block2e_se_expand_res1/convolution', in_channels=10, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2e_project_conv_res1_convolution = self.__conv(2, name='block2e_project_conv_res1/convolution', in_channels=240, out_channels=40, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2e_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2e_project_bn_res1/FusedBatchNorm_1', num_features=40, eps=0.0010000000474974513, momentum=0.0)
        self.block3a_expand_conv_res1_convolution = self.__conv(2, name='block3a_expand_conv_res1/convolution', in_channels=40, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3a_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3a_expand_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block3a_dwconv_res1_depthwise = self.__conv(2, name='block3a_dwconv_res1/depthwise', in_channels=240, out_channels=240, kernel_size=(5, 5), stride=(2, 2), groups=240, bias=None)
        self.block3a_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3a_bn_res1/FusedBatchNorm_1', num_features=240, eps=0.0010000000474974513, momentum=0.0)
        self.block3a_se_reduce_res1_convolution = self.__conv(2, name='block3a_se_reduce_res1/convolution', in_channels=240, out_channels=10, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3a_se_expand_res1_convolution = self.__conv(2, name='block3a_se_expand_res1/convolution', in_channels=10, out_channels=240, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3a_project_conv_res1_convolution = self.__conv(2, name='block3a_project_conv_res1/convolution', in_channels=240, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3a_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3a_project_bn_res1/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.block3b_expand_conv_res1_convolution = self.__conv(2, name='block3b_expand_conv_res1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3b_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3b_expand_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3b_dwconv_res1_depthwise = self.__conv(2, name='block3b_dwconv_res1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.block3b_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3b_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3b_se_reduce_res1_convolution = self.__conv(2, name='block3b_se_reduce_res1/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3b_se_expand_res1_convolution = self.__conv(2, name='block3b_se_expand_res1/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3b_project_conv_res1_convolution = self.__conv(2, name='block3b_project_conv_res1/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3b_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3b_project_bn_res1/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.block3c_expand_conv_res1_convolution = self.__conv(2, name='block3c_expand_conv_res1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3c_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3c_expand_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3c_dwconv_res1_depthwise = self.__conv(2, name='block3c_dwconv_res1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.block3c_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3c_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3c_se_reduce_res1_convolution = self.__conv(2, name='block3c_se_reduce_res1/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3c_se_expand_res1_convolution = self.__conv(2, name='block3c_se_expand_res1/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3c_project_conv_res1_convolution = self.__conv(2, name='block3c_project_conv_res1/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3c_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3c_project_bn_res1/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.block3d_expand_conv_res1_convolution = self.__conv(2, name='block3d_expand_conv_res1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3d_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3d_expand_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3d_dwconv_res1_depthwise = self.__conv(2, name='block3d_dwconv_res1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.block3d_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3d_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3d_se_reduce_res1_convolution = self.__conv(2, name='block3d_se_reduce_res1/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3d_se_expand_res1_convolution = self.__conv(2, name='block3d_se_expand_res1/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3d_project_conv_res1_convolution = self.__conv(2, name='block3d_project_conv_res1/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3d_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3d_project_bn_res1/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.block3e_expand_conv_res1_convolution = self.__conv(2, name='block3e_expand_conv_res1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3e_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3e_expand_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3e_dwconv_res1_depthwise = self.__conv(2, name='block3e_dwconv_res1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.block3e_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3e_bn_res1/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.block3e_se_reduce_res1_convolution = self.__conv(2, name='block3e_se_reduce_res1/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3e_se_expand_res1_convolution = self.__conv(2, name='block3e_se_expand_res1/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3e_project_conv_res1_convolution = self.__conv(2, name='block3e_project_conv_res1/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3e_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3e_project_bn_res1/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv1_skeleton_conv1_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_conv1/convolution', in_channels=88, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv1_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv1_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv1_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block1_mbconv1_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block1_mbconv1_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv1_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv1_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv1_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv1_skeleton_conv2_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv1_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv1_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv2_skeleton_conv1_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv2_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv2_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv2_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block1_mbconv2_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block1_mbconv2_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv2_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv2_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv2_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv2_skeleton_conv2_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv2_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv2_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv3_skeleton_conv1_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv3_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv3_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv3_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block1_mbconv3_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block1_mbconv3_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv3_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv3_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv3_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv3_skeleton_conv2_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv3_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv3_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv1_skeleton_conv1_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_conv1/convolution', in_channels=192, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv1_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv1_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv1_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block2_mbconv1_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block2_mbconv1_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv1_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv1_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv1_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv1_skeleton_conv2_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv1_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv1_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv2_skeleton_conv1_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv2_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv2_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv2_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block2_mbconv2_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block2_mbconv2_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv2_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv2_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv2_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv2_skeleton_conv2_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv2_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv2_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv3_skeleton_conv1_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv3_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv3_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv3_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block2_mbconv3_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block2_mbconv3_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv3_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv3_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv3_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv3_skeleton_conv2_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv3_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv3_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv1_skeleton_conv1_convolution = self.__conv(2, name='pass1_block3_mbconv1_skeleton_conv1/convolution', in_channels=192, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block3_mbconv1_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv1_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv1_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block3_mbconv1_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block3_mbconv1_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv1_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv1_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block3_mbconv1_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block3_mbconv1_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block3_mbconv1_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block3_mbconv1_skeleton_conv2_convolution = self.__conv(2, name='pass1_block3_mbconv1_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block3_mbconv1_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv1_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv2_skeleton_conv1_convolution = self.__conv(2, name='pass1_block3_mbconv2_skeleton_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block3_mbconv2_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv2_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv2_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block3_mbconv2_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block3_mbconv2_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv2_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv2_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block3_mbconv2_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block3_mbconv2_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block3_mbconv2_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block3_mbconv2_skeleton_conv2_convolution = self.__conv(2, name='pass1_block3_mbconv2_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block3_mbconv2_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv2_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv3_skeleton_conv1_convolution = self.__conv(2, name='pass1_block3_mbconv3_skeleton_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block3_mbconv3_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv3_skeleton_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv3_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block3_mbconv3_skeleton_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass1_block3_mbconv3_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv3_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block3_mbconv3_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block3_mbconv3_skeleton_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block3_mbconv3_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block3_mbconv3_skeleton_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block3_mbconv3_skeleton_conv2_convolution = self.__conv(2, name='pass1_block3_mbconv3_skeleton_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block3_mbconv3_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block3_mbconv3_skeleton_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv1_detection1_conv1_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_conv1/convolution', in_channels=280, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv1_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv1_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv1_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block1_mbconv1_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block1_mbconv1_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv1_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv1_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv1_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv1_detection1_conv2_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv1_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv1_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv2_detection1_conv1_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv2_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv2_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv2_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block1_mbconv2_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block1_mbconv2_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv2_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv2_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv2_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv2_detection1_conv2_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv2_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv2_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv3_detection1_conv1_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv3_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv3_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv3_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block1_mbconv3_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block1_mbconv3_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv3_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv3_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv3_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv3_detection1_conv2_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv3_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv3_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv1_detection1_conv1_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_conv1/convolution', in_channels=192, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv1_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv1_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv1_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block2_mbconv1_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block2_mbconv1_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv1_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv1_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv1_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv1_detection1_conv2_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv1_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv1_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv2_detection1_conv1_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv2_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv2_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv2_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block2_mbconv2_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block2_mbconv2_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv2_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv2_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv2_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv2_detection1_conv2_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv2_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv2_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv3_detection1_conv1_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv3_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv3_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv3_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block2_mbconv3_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block2_mbconv3_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv3_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv3_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv3_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv3_detection1_conv2_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv3_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv3_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv1_detection1_conv1_convolution = self.__conv(2, name='pass2_block3_mbconv1_detection1_conv1/convolution', in_channels=192, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block3_mbconv1_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv1_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv1_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block3_mbconv1_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block3_mbconv1_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv1_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv1_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block3_mbconv1_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block3_mbconv1_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block3_mbconv1_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block3_mbconv1_detection1_conv2_convolution = self.__conv(2, name='pass2_block3_mbconv1_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block3_mbconv1_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv1_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv2_detection1_conv1_convolution = self.__conv(2, name='pass2_block3_mbconv2_detection1_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block3_mbconv2_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv2_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv2_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block3_mbconv2_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block3_mbconv2_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv2_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv2_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block3_mbconv2_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block3_mbconv2_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block3_mbconv2_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block3_mbconv2_detection1_conv2_convolution = self.__conv(2, name='pass2_block3_mbconv2_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block3_mbconv2_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv2_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv3_detection1_conv1_convolution = self.__conv(2, name='pass2_block3_mbconv3_detection1_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block3_mbconv3_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv3_detection1_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv3_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block3_mbconv3_detection1_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass2_block3_mbconv3_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv3_detection1_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block3_mbconv3_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block3_mbconv3_detection1_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block3_mbconv3_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block3_mbconv3_detection1_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block3_mbconv3_detection1_conv2_convolution = self.__conv(2, name='pass2_block3_mbconv3_detection1_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block3_mbconv3_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block3_mbconv3_detection1_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv1_detection2_conv1_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_conv1/convolution', in_channels=280, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv1_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv1_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv1_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block1_mbconv1_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block1_mbconv1_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv1_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv1_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv1_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv1_detection2_conv2_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv1_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv1_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv2_detection2_conv1_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv2_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv2_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv2_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block1_mbconv2_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block1_mbconv2_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv2_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv2_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv2_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv2_detection2_conv2_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv2_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv2_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv3_detection2_conv1_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv3_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv3_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv3_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block1_mbconv3_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block1_mbconv3_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv3_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv3_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv3_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv3_detection2_conv2_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv3_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv3_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv1_detection2_conv1_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_conv1/convolution', in_channels=192, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv1_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv1_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv1_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block2_mbconv1_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block2_mbconv1_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv1_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv1_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv1_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv1_detection2_conv2_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv1_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv1_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv2_detection2_conv1_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv2_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv2_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv2_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block2_mbconv2_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block2_mbconv2_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv2_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv2_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv2_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv2_detection2_conv2_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv2_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv2_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv3_detection2_conv1_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv3_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv3_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv3_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block2_mbconv3_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block2_mbconv3_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv3_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv3_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv3_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv3_detection2_conv2_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv3_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv3_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv1_detection2_conv1_convolution = self.__conv(2, name='pass3_block3_mbconv1_detection2_conv1/convolution', in_channels=192, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block3_mbconv1_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv1_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv1_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block3_mbconv1_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block3_mbconv1_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv1_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv1_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block3_mbconv1_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block3_mbconv1_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block3_mbconv1_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block3_mbconv1_detection2_conv2_convolution = self.__conv(2, name='pass3_block3_mbconv1_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block3_mbconv1_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv1_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv2_detection2_conv1_convolution = self.__conv(2, name='pass3_block3_mbconv2_detection2_conv1/convolution', in_channels=64, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block3_mbconv2_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv2_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv2_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block3_mbconv2_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block3_mbconv2_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv2_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv2_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block3_mbconv2_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block3_mbconv2_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block3_mbconv2_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block3_mbconv2_detection2_conv2_convolution = self.__conv(2, name='pass3_block3_mbconv2_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block3_mbconv2_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv2_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv3_detection2_conv1_convolution = self.__conv(2, name='pass3_block3_mbconv3_detection2_conv1/convolution', in_channels=128, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block3_mbconv3_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv3_detection2_conv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv3_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block3_mbconv3_detection2_dconv1/depthwise', in_channels=384, out_channels=384, kernel_size=(5, 5), stride=(1, 1), groups=384, bias=None)
        self.pass3_block3_mbconv3_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv3_detection2_dconv1_bn/FusedBatchNorm_1', num_features=384, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block3_mbconv3_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block3_mbconv3_detection2_se_se_squeeze_conv/convolution', in_channels=384, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block3_mbconv3_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block3_mbconv3_detection2_se_se_excite_conv/convolution', in_channels=16, out_channels=384, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block3_mbconv3_detection2_conv2_convolution = self.__conv(2, name='pass3_block3_mbconv3_detection2_conv2/convolution', in_channels=384, out_channels=64, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block3_mbconv3_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block3_mbconv3_detection2_conv2_bn/FusedBatchNorm_1', num_features=64, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_detection2_confs_convolution = self.__conv(2, name='pass3_detection2_confs/convolution', in_channels=192, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
    ...
    def forward(self, x):
        ...
        block1b_se_reshape_res2_Reshape = torch.reshape(input = block1b_se_squeeze_res2_Mean, shape = (-1,16,1,1))#(-1,1,1,16))
        ...
        block1c_se_reshape_res1_Reshape = torch.reshape(input = block1c_se_squeeze_res1_Mean, shape = (-1,24,1,1))#(-1,1,1,24))
        ...
        block2a_expand_conv_res1_convolution = self.block2a_expand_conv_res1_convolution(block1c_add_res1_add)
        ...
        block2b_se_reshape_res1_Reshape = torch.reshape(input = block2b_se_squeeze_res1_Mean, shape = (-1,240,1,1))#(-1,1,1,240))
        ...
        block2c_se_reshape_res2_Reshape = torch.reshape(input = block2c_se_squeeze_res2_Mean, shape = (-1,144,1,1))#(-1,1,1,144))
        ...
        block2c_se_reshape_res1_Reshape = torch.reshape(input = block2c_se_squeeze_res1_Mean, shape = (-1,240,1,1))#(-1,1,1,240))
        ...
        block2d_se_reshape_res1_Reshape = torch.reshape(input = block2d_se_squeeze_res1_Mean, shape = (-1,240,1,1))#(-1,1,1,240))
        ...
        block2e_se_reshape_res1_Reshape = torch.reshape(input = block2e_se_squeeze_res1_Mean, shape = (-1,240,1,1))#(-1,1,1,240))
        ...
        block3a_expand_conv_res1_convolution = self.block3a_expand_conv_res1_convolution(block2e_add_res1_add)
        ...
        block3a_se_reshape_res1_Reshape = torch.reshape(input = block3a_se_squeeze_res1_Mean, shape = (-1,240,1,1))#(-1,1,1,240))
        ...
        block3b_se_reshape_res1_Reshape = torch.reshape(input = block3b_se_squeeze_res1_Mean, shape = (-1,384,1,1))#(-1,1,1,384))
        ...
        block3c_se_reshape_res1_Reshape = torch.reshape(input = block3c_se_squeeze_res1_Mean, shape = (-1,384,1,1))#(-1,1,1,384))
        ...
        block3d_se_reshape_res1_Reshape = torch.reshape(input = block3d_se_squeeze_res1_Mean, shape = (-1,384,1,1))#(-1,1,1,384))
        ...
        block3e_se_reshape_res1_Reshape = torch.reshape(input = block3e_se_squeeze_res1_Mean, shape = (-1,384,1,1))#(-1,1,1,384))
        ...
        concatenate_1_concat = torch.cat((block3e_add_res1_add, block2c_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        concatenate_2_concat = torch.cat((pass1_block3_skip_skeleton_add, block3e_add_res1_add, block2c_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        concatenate_3_concat = torch.cat((pass2_block3_skip_detection1_add, block3e_add_res1_add, block2c_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        pass3_detection2_confs_convolution = self.pass3_detection2_confs_convolution(pass3_block3_skip_detection2_add)
